...
<body>
	<%
		...
		ArrayList<ProductBean> mylist = (ArrayList<ProductBean>) new ProductDAO().getAllListByRemedies(bean.getRemediesId());
		Gson gson = new Gson();
	...
	<div class="container posrel" style="z-index: 2;">
		<br> <br> <br>
		<h3 class="tcenter bold text-2 fgwhite">Remedies</h3>
		...
		<div class="row">
			<div class="cs7 nomargin overhidden"
				...
				<input type="text" class="textbox posrel searchbox"
					style="top: 5px;" placeholder="Search Products" />
			</div>
