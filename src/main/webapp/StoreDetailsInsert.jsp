			...
			<div class="container">
				<form action="StoreDetailsInsertServlet" method="post">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<input class="form-control" type="text" value="${txtStoreName}"
								name="txtStoreName" />${name}
						</div>
					</div>
					<br />
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<textarea class="form-control" rows="5" cols="50"
								name="txtAddress">${txtAddress}</textarea>${address}
						</div>
					</div>
					<br />
					<div class="row">
						...
						<div class="col-lg-6">
							<input class="form-control" type="text" value="${txtCN1}"
								name="txtCN1" />${CN1}
						</div>
					</div>
					<br />
					<div class="row">
						...
						<div class="col-lg-6">
							<input class="form-control" type="text" value="${txtCN2}"
								name="txtCN2" />${CN2}
						</div>
					</div>
					<br /> <br /> <br /> <br /> <label
