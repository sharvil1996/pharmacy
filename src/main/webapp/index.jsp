			...
			<div class="owl-carousel owl-theme remedies">
				...
				<div class="item tcenter">
					<a href="<%=list.get(i).getForwardLink()%>"
						class="inblock fgblack homeRemedies"> <img
						src="<%=list.get(i).getPhotolink()%>" />
		...
		<div class="owl-carousel owl-theme knowYourMedicines">
			<div class="item tcenter">
				<div class="bgwhite inblock knowYourMedicine">
					...
					<h4>Medicine Name</h4>
					<p>Suspendisse aliquet metus tellus, at auctor sapien interdum
						at. Nullam dictum arcu dui. Maecenas non mollis dolor.</p>
				</div>
			</div>
			<div class="item tcenter">
				<div class="bgwhite inblock knowYourMedicine">
		...
		<div class="row">
			<div class="cm6 nomargin tcenter">
				<h1 class="fgwhite" style="margin-bottom: 10px;">We're Making
					Medicine Healthier and Purer</h1>
				<p class="fgwhite nomargin" style="font-size: 1.4em;">We're on a
					mission to bring cleaner, more effective medicines to children and
					families.</p>
				<br> <a href="#" class="button uppercase">More About Us</a>
			</div>
		</div>
		<br>
	</div>
