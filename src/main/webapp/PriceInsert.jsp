...
<title>Admin | Product Price Insert</title>
<noscript>
...
<body>
	...
	<div style="margin-top: -850px; margin-left: 250px;">
		...
		<h1>
			Product Price <small>Insert</small>
		</h1>
		<ol class="breadcrumb">
				...
				<form action="PriceInsertSevlet" method="post">
					...
					<br />
					 <div class="row">
						...
						<div class="col-lg-6">
							<input type="text" class="form-control" value="${txtPackageSize}"
								name="txtPackageSize" />${packageName}
						</div>
					</div>
					<br />
					<div class="row">
