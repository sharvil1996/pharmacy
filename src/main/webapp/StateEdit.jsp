...
<title>Admin | State Update</title>
<noscript>
...
<body>
	<form action="StateUpdateServlet" method="post">
		...
		<input type="hidden" name="stateId" value=<%=stateBean.getStateId()%>>
		<table>
			<tr>
				<td>Enter State Name</td>
				<td><input type="text" value="<%=stateBean.getStateName()%>"
					name="txtStateName" />${stateName}</td>
			<tr>
			<tr>
				<td>Submit</td>
