...
!function ($) {
    ...
    Password.DEFAULTS = {
        ...
        eyeClass: 'icon-preview',
        eyeOpenClass: 'icon-preview',
        eyeCloseClass: 'icon-preview'
    };
    ...
    Password.prototype.init = function() {
        ...
        this.$icon = $([
            ...
            '<div class="icon-container icon-preview"><i class="material-icons dp48' + (this.options.white ? ' icon-white' : '') +
                ' ' + this.options.eyeClass + ' ' + this.options.eyeOpenClass + '">' +this.s+'</i></div>',
            '</span>'
