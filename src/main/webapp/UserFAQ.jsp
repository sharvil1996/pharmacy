...
<section class="bgimage"
	...
	<div class="container posrel" style="z-index: 2;">
		...
		<div class="tcenter fgwhite jumbotext text-2"
			style="margin-bottom: 40px;">FAQ on Homoeopathy</div>
		<br>
		<br>
		<br>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="cs3 hideResponsive">
				...
				<a href="#" class="button white full linkButton active margin">FAQ
					on Homoeopathy</a> <a href="#"
					class="button white full linkButton black margin">Know Your
					Medicine</a> <a href="#"
					class="button white full linkButton black margin">Mind, Body &
					Spirit</a> <a href="#"
					class="button white full linkButton black margin">Homoeopathic
					Self-Help</a>
			</div>
			<div class="cs9">
				<%
				...
				<p class="paragraph" style="margin-top: 5px;"><%=arrayList.get(i).getAnswer() %>
				<p>
					<%
					}
					%>
